...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("SELECT * FROM aluno WHERE reset_token = ?");
    $stmt->execute([$codigo]);
    $usuarios = $stmt->fetch();
    ...
    if ($usuarios) {
        ...
        $stmt = $pdo->prepare("UPDATE aluno SET senha = ?, reset_token = NULL WHERE reset_token = ?");
...
<body>
    ...
    <p><a href="../../view/aluno/loginAluno.php">Voltar à página de login</a></p>
    </div>
</body>
</html>
