...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("SELECT * FROM empresa WHERE reset_token = ?");
    $stmt->execute([$codigo]);
    $usuarios = $stmt->fetch();
    ...
    if ($usuarios) {
        ...
        $stmt = $pdo->prepare("UPDATE empresa SET senha = ?, reset_token = NULL WHERE reset_token = ?");
...
<body>
    ...
    <p><a href="../../view/empresa/loginEmpresa.php">Voltar à página de login</a></p>
    </div>
</body>
</html>
